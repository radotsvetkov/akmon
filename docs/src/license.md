...
Akmon is licensed under the [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0).

The full text is in the repository root as [`LICENSE`](https://github.com/radotsvetkov/akmon/blob/main/LICENSE).
